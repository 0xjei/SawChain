...
/**
 * Custom Chai assertion to assert that a string is an hexadecimal string.
 */
...
/**
 * Custom Chai assertion to assert that a promise has been rejected with a particular error type.
 */
